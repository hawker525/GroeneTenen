...
class JdbcFiliaalRepository implements FiliaalRepository {
    ...
    private final RowMapper<Filiaal> rowMapper = (resultSet, rowNum) -> new Filiaal(
...
//        return Collections.unmodifiableList(new ArrayList<>(filialen.values()));
