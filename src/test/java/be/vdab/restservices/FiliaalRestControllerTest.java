...
@ContextConfiguration(classes = {TestDataSourceConfig.class, TestRepositoriesConfig.class, ServicesConfig.class, ControllersConfig.class, RestControllersConfig.class})
@WebAppConfiguration
@Transactional
